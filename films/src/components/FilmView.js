                ...
                <div className="moviePage">
                    ...
                    <section className="movieDetails">
                        <h2 className="sectionTitle">{film.title}
                            <a className='svgHolder' onClick={this.openEditModal}>
                        ...
                        <ul className="detailsList">
                            <li><span className="bold">Year of Release:</span> {film.year}</li>
                            ...
                            <li><span className="bold">Vote count:</span> {count}
                                <a className='svgHolder' onClick={this.openRatingModal}>
